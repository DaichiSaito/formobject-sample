class CompaniesController < ApplicationController
  ...
  # GET /companies/new
  def new
    @company_registration_form = CompanyRegistrationForm.new(users: [User.new, User.new, User.new])
  end
  ...
  def create
    ...
    if @company_registration_form.save
      redirect_to @company_registration_form.company, notice: 'Company was successfully created.'
    else
      render :new
    end
  end
